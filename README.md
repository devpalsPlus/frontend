...
| 메인 페이지 |
| -------- |
| <img src="./src/assets/preview/main.png" width="300"/>

| 프로젝트 상세페이지                                              | 지원하기 페이지                                          | 모집공고 작성 페이지                                             |
| ---------------------------------------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------------- |
| <img src="./src/assets/preview/projectdetail.png" width="300" /> | <img src="./src/assets/preview/apply.png" width="300" /> | <img src="./src/assets/preview/createproject.png" width="300" /> |

| 로그인 페이지                                            | 회원가입 페이지                                           | 비밀번호 재설정 페이지                                             |
| -------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------ |
| <img src="./src/assets/preview/login.png" width="300" /> | <img src="./src/assets/preview/signup.png" width="300" /> | <img src="./src/assets/preview/change-password.png" width="300" /> |

| 모집 공고 관리 페이지                                         | 지원자 리스트 페이지                                               | 합/불합 리스트 페이지                                          |
| ------------------------------------------------------------- | ------------------------------------------------------------------ | -------------------------------------------------------------- |
| <img src="./src/assets/preview/managelist.png" width="300" /> | <img src="./src/assets/preview/applicationlist.png" width="300" /> | <img src="./src/assets/preview/passnonpass.png" width="300" /> |

| 마이 페이지(프로필)                                       | 마이 페이지(참여 프로젝트 현황)                               | 마이 페이지(지원 프로젝트 현황)                                |
| --------------------------------------------------------- | ------------------------------------------------------------- | -------------------------------------------------------------- |
| <img src="./src/assets/preview/mypage.png" width="300" /> | <img src="./src/assets/preview/joinedlist.png" width="300" /> | <img src="./src/assets/preview/appliedlist.png" width="300" /> |

| 유저 페이지(프로필)                                         | 유저 페이지(참여 프로젝트 현황)                                 |
| ----------------------------------------------------------- | --------------------------------------------------------------- |
| <img src="./src/assets/preview/userpage.png" width="300" /> | <img src="./src/assets/preview/userporjects.png" width="300" /> |
